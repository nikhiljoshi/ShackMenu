...
import com.nikhil.shackmenu.interfaces.AnimationListenerAdapter;
...
import com.nikhil.shackmenu.interfaces.ShackCommonMethod;
import com.nikhil.shackmenu.interfaces.ShackMenuListener;
import com.nikhil.shackmenu.util.Preconditions;
import com.nikhil.shackmenu.util.ViewUtils;
import com.nikhil.shackmenu.view.BackgroundView;
 ...
 */
public class ShackMenu implements ShackCommonMethod {
    ...
    private ShackMenuListener mShackMenuListener;
    private OnShackItemClickListener mTimoItemClickListener;
    private OnShackItemTouchListener mTimoItemTouchListener;

    protected ShackMenu(Activity activity){
        mRootView = (ViewGroup) activity.getWindow().getDecorView();

        init();
    }

    protected ShackMenu(ViewGroup rootView){
        mRootView = rootView;
        init();
    }
    ...
    protected void setDividerLine(ShackDividerLine dividerLine) {
    ...
    protected void setTimoMenuListener(ShackMenuListener shackMenuListener) {
        this.mShackMenuListener = shackMenuListener;
    }

    protected void setTimoItemClickListener(OnShackItemClickListener timoItemClickListener) {
        this.mTimoItemClickListener = timoItemClickListener;
    }

    protected void setTimoItemTouchListener(OnShackItemTouchListener itemTouchListener) {
    ...
    public void addRow(ItemAnimation itemAnimation, List<ShackItemViewParameter> shackItemViewParameters) {
        mMenuView.addRow(itemAnimation, shackItemViewParameters);
    }
    ...
    private void showFinished(){
        if (mShackMenuListener != null){
            mShackMenuListener.onShow();
        }
        mAnimationCounter = 0;
        mMenuView.didShow();
    }
    ...
    @Override
    public List<List<ShackItemView>> getRows() {
    ...
    public static class Builder {
         ...
         * */
        public Builder setDividerLine(ShackDividerLine dividerLine) {
         ...
         *
         * @param shackMenuListener The menu listener.
         * */
        public Builder setTimoMenuListener(ShackMenuListener shackMenuListener) {
            mImpl.setTimoMenuListener(shackMenuListener);
            return this;
        }
         ...
         * */
        public Builder setTimoItemClickListener(OnShackItemClickListener timoItemClickListener) {
         ...
         * */
        public Builder setTimoItemTouchListener(OnShackItemTouchListener itemTouchListener) {
         ...
         * @param shackItemViewParameters The parameter of the item views.
         * */
        public Builder addRow(ItemAnimation itemAnimation, List<ShackItemViewParameter> shackItemViewParameters){
            mImpl.addRow(itemAnimation, shackItemViewParameters);
            return this;
        }
